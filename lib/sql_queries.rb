...
"SELECT projects.title, (SUM(pledges.amount) - projects.funding_goal) AS a1 FROM projects JOIN pledges ON projects.id = pledges.project_id GROUP BY projects.title HAVING a1 >= 0"
end
